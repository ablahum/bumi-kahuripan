  ...
  <div class="md:w-2/3 lg:w-2/5 w-11/12 bg-white rounded-xl shadow-xl p-8">
    <div class="mb-4 text-center">
      ...
      <p class="font-semibold mt-2">
        <span class="capitalize">silakan </span>buat akun sebelum melanjutkan
      </p>
    </div>
    ...
    <div class="mb-4">
      ...
      <p v-if="errors.password" class="text-red-500 font-semibold text-end">
        {{ errors.password }}
      </p>
    </div>
    ...
    <p class="text-center mt-4">
      ...
      <RouterLink to="/login" class="capitalize text-indigo-700 font-semibold"
        >masuk </RouterLink
      >saja
    </p>
  </div>
